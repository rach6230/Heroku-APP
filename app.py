...
all_df=[ALL_data_fit_values_v5,ALL_data_fit_values_v6,ALL_data_fit_values_v7, ALL_data_fit_values_v8,
        ...
        ALL_data_fit_values_v23,ALL_data_fit_values_v24]
...
all_git_df=[Github_urls_v5, Github_urls_v6, Github_urls_v7, Github_urls_v8,Github_urls_v9,
            ...
            Github_urls_v23,Github_urls_v24]
...
def update_figure(data_version):
  if data_version == 0 or data_version == 1 or data_version ==2 or data_version ==3 or data_version == 4 or data_version ==5 or data_version == 10 or data_version == 11 or data_version == 12 or data_version == 13 :        
    A = 'Scan Type = 3D'
  if data_version ==6 or data_version == 7 or data_version == 8 or data_version == 9 or data_version == 14 or data_version == 15 or data_version == 16 or data_version == 17or data_version == 18 or data_version == 19 or data_version == 20 or data_version == 21 or data_version == 22 or data_version == 23:  
    A = 'Scan Type = 2D/1D'
  return A
...
def update_figure(scan_type, data_version):
    if scan_type == 'Scan Type = 2D/1D': 
        if data_version== 14 or data_version== 15 or data_version== 16 or data_version== 17 or data_version== 18 or data_version== 19 or data_version== 20 or data_version== 21 or data_version== 22 or data_version== 23: 
            A = dcc.RadioItems(
...
def update_figure(clickData, data_version, scan_type):
    if scan_type == 'Scan Type = 2D/1D': 
        ...
        if  data_version ==20 or data_version ==21 or data_version ==22 or data_version ==23:
            df.columns = df.iloc[0]
            df =df.iloc[1:]
            df.reset_index(drop=True, inplace=True)   
